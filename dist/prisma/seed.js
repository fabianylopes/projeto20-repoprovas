...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var terms, categories, teachers, disciplines, teachersDisciplines, tests;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, prisma.teachersDiscipline.createMany({ data: teachersDisciplines })];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, prisma.test.createMany({ data: tests })];
                case 6:
                    _a.sent();
                    return [2 /*return*/];
            }
