...
function SignIn() {
    ...
    function handleSubmit(e) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, token, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        e.preventDefault();
                        setMessage(null);
                        if (!(formData === null || formData === void 0 ? void 0 : formData.email) || !(formData === null || formData === void 0 ? void 0 : formData.password)) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api.signIn({ email: email, password: password })];
                    case 2:
